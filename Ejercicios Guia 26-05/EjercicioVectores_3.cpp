/*
3)	Crea un pseudocódigo que cargue un vector de 5 elementos y luego lo ordene ascendentemente
utilizando el método de burbuja. Imprime el vector Antes y después de ordenar.
*/
#include <iostream>
#include <cstdlib>
#include <ctime>
